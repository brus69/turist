...
def _inst(iid: str, name: str, unsplash_avatar_id: str):
    return [{"id": iid, "name": name, "avatarUrl": img(unsplash_avatar_id, 200, 200)}]
...
SEED_TOURS = [
    {
        ...
        "instructors": _inst("i1", "Георгий Айвазошвили", "1507003211189-015e2fc17ecb"),
        "season": "summer",
        "holiday": ["may"],
    ...
    },
    {
        ...
        "faq": [],
        "instructors": _inst("i2", "Мария Соколова", "1494790108377-be9c29b29330"),
        "season": "spring",
        "holiday": ["may"],
    ...
    },
    {
        ...
        "instructors": _inst("i3", "Алексей Вершинин", "1500648769291-c17bf87fedd5"),
        "season": "summer",
        "holiday": [],
